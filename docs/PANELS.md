...
drives that same bundle. That is _why_ the output is byte-identical: there is one
...
Faking a runtime would defeat the entire point — the playground exists to _prove_
